...
public class AstarPath : MonoBehaviour {
	...
	public const AstarDistribution Distribution = AstarDistribution.AssetStore;
...
#if DEBUG
		Debug.Log ("Flood fill complete, "+area+" area"+(area > 1 ? "s" : "")+" found - "+((System.DateTime.Now.Ticks-startTime.Ticks)*0.0001).ToString ("0.00")+" ms");
#endif
	}
